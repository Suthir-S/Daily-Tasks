...
import com.quinbay.retailer.api.RetDisplay;
...
@Service
public class RetDetails implements RetDisplay {
    @Override
    public String getDetails(int id) { //Get wholesaler details according to wholesaler id
        ArrayList<Retailer> retailer_details = RetService.retailer_details;
        String str="";
