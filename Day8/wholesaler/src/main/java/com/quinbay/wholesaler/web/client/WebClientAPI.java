...
public class WebClientAPI {
    ...
    public Product[] getProducts(){
       ...
       return  restTemplate.exchange("http://localhost:8081/getProducts",HttpMethod.GET,entity,Product[].class).getBody();
    ...
    public String updateProduct(Product products){
        ...
        return restTemplate.exchange("http://localhost:8081/updateProduct",HttpMethod.POST,entity,String.class).getBody();
